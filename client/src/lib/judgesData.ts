...
export const mockJudges: Judge[] = [
  {
    ...
    shortBio: 'AI Architect at AWS with 12+ years building ML systems. Mentored 500+ innovators across 3 continents.',
  ...
  },
  {
    ...
    shortBio: 'Product Manager at Meta, previously founded two startups. Passionate about helping builders create their first products.',
    ...
    mentorshipStatement: 'Product thinking is a superpower. I love seeing participants discover that they can solve real problems.',
  ...
  },
  {
    ...
    mentorshipStatement: 'Code quality matters. I focus on helping participants write maintainable, production-ready code.',
    availabilityStatus: 'available',
    tier: 'verified',
    isPublished: true,
  ...
  },
  {
    ...
    mentorshipStatement: 'Games are the most creative form of software. I love helping participants discover the joy of building interactive experiences.',
    availabilityStatus: 'available',
    tier: 'verified',
    isPublished: true,
  ...
  },
  {
    ...
    mentorshipStatement: 'Data tells stories. I help participants learn to listen and build systems that make impact.',
  ...
  },
  {
    ...
    shortBio: 'Electrical engineer and hardware hacker. Building IoT solutions for developing communities.',
    ...
    mentorshipStatement: 'Hardware is harder, but more rewarding. I want to help participants discover the magic of building physical things.',
    availabilityStatus: 'seasonal',
    tier: 'starter',
    isPublished: true,
