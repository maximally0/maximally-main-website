    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <h2 className="font-space font-bold text-xl bg-gradient-to-r from-orange-400 to-orange-500 bg-clip-text text-transparent">ANNOUNCEMENTS</h2>
        </div>
        <button
      ...
      <div className="space-y-4">
        {announcements.length === 0 ? (
          <div className="bg-gradient-to-br from-gray-800/50 to-gray-900/50 border border-gray-700 p-12 text-center">
            ...
            <p className="font-space font-bold text-gray-400">NO_ANNOUNCEMENTS_YET</p>
          </div>
        ) : (
          announcements.map((announcement) => (
            <div
              ...
              className={`bg-gradient-to-br from-gray-900/60 to-gray-900/30 border p-6 transition-all ${
                announcement.is_published ? 'border-green-500/50 hover:border-green-400/70' : 'border-gray-700 hover:border-gray-800'
              }`}
            >
              <div className="flex items-start justify-between mb-3">
                <div className="flex-1">
                  <div className="flex items-center gap-3 mb-2 flex-wrap">
                    <h3 className="font-space font-bold text-lg text-white">{announcement.title}</h3>
                    ...
                    <span className="px-3 py-1 text-xs font-space font-bold bg-orange-500/10 text-orange-400 border border-orange-500/50 uppercase">
                      {announcement.announcement_type}
                    </span>
                  </div>
                  <p className="text-gray-300 font-space text-sm mb-3">{announcement.content}</p>
                  <div className="flex items-center gap-4 text-xs text-gray-400 font-space flex-wrap">
                ...
                <div className="flex items-center gap-2 flex-wrap">
                  {!announcement.is_published && (
                    <button
                      ...
                      className="bg-gradient-to-r from-green-600/60 to-emerald-500/40 border border-green-500/50 hover:border-green-400 text-green-200 px-3 py-2 font-space font-bold text-xs transition-all flex items-center gap-1"
                      title="Publish Draft"
                    >
                  ...
                  <button
                    ...
                    className="bg-gradient-to-r from-gray-700/60 to-blue-500/40 border border-gray-700 hover:border-gray-600 text-gray-300 px-3 py-2 font-space font-bold text-xs transition-all flex items-center gap-1"
                  ...
                  <button
                    ...
                    className="bg-gradient-to-r from-red-600/60 to-rose-500/40 border border-red-500/50 hover:border-red-400 text-red-200 px-3 py-2 font-space font-bold text-xs transition-all flex items-center gap-1"
          ...
          <div className="bg-gradient-to-br from-gray-900 to-gray-950 border border-orange-500/50 max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            <div className="p-6 border-b border-gray-800 bg-gradient-to-r from-gray-900/40 to-gray-900/20">
              <div className="flex items-center justify-between">
                ...
                <button onClick={closeModal} className="text-gray-400 hover:text-orange-400 transition-colors">
                  <X className="h-6 w-6" />
                </button>
              </div>
            </div>
            ...
            <div className="p-6 space-y-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  <label className="font-space text-sm text-gray-300 mb-2 block">Target Audience</label>
                  <select
              ...
              <div className="flex items-center gap-3">
                ...
                />
                <label htmlFor="send_email" className="font-space text-sm text-gray-300">
                ...
                {editingAnnouncement ? (
                  <>
                    <button
                      ...
                      className="flex-1 bg-gray-800/50 border border-gray-700 hover:border-gray-600 text-gray-300 hover:text-white px-6 py-3 font-space font-bold text-sm transition-all"
                    >
                      SAVE_CHANGES
                    </button>
                    {!editingAnnouncement.is_published && (
                      <button
                        ...
                        className="flex-1 bg-gradient-to-r from-orange-600 to-orange-500 hover:from-orange-500 hover:to-orange-500 text-white px-6 py-3 font-space font-bold text-sm transition-all flex items-center justify-center gap-2 border border-orange-500/40"
                      >
        ...
        <div className="fixed inset-0 bg-black/90 backdrop-blur-sm flex items-center justify-center p-4 z-50">
          <div className="bg-gradient-to-br from-gray-900 to-gray-950 border border-red-500/50 max-w-md w-full">
            <div className="p-6 border-b border-red-500/30 bg-gradient-to-r from-red-900/30 to-rose-900/20">
              <h2 className="font-space font-bold text-xl text-red-400">DELETE_ANNOUNCEMENT</h2>
            </div>
            <div className="p-6 space-y-4">
              ...
              <div className="flex gap-3">
                ...
                <button
                  ...
                  className="flex-1 bg-gradient-to-r from-red-600/60 to-rose-500/40 border border-red-500/50 hover:border-red-400 text-red-200 px-6 py-3 font-space font-bold text-sm transition-all"
                >
                  DELETE
                </button>
              </div>
