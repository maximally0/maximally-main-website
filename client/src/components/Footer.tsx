            ...
            {[
              {
                ...
                date: 'SEP',
                icon: '🧪',
                path: '/hackathon/codehypothesis',
              },
              {
                name: 'PROTOCOL 404',
                date: 'OCT',
                icon: '⚡',
                path: '/hackathon/protocol-404',
              },
              {
                name: 'CODEGEN',
                date: 'OCT',
                icon: '📝',
                path: '/hackathon/project-codegen',
              },
              {
                name: 'CODEPOCALYPSE',
                date: 'OCT 18-19',
                icon: '☢️',
                path: '/hackathon/codepocalypse',
              },
              {
                name: 'HACKTOBER',
                date: 'OCT',
                icon: '🍂',
                path: '/hackathon/hacktober',
              },
              {
                name: 'PROMPTSTORM',
                date: 'OCT 25-26',
                icon: '⚡',
                path: '/hackathon/prompt-storm',
              },
              {
                name: 'TECH ASSEMBLY',
                date: 'NOV 1-7',
                icon: '🎮',
                path: '/hackathon/grand-tech-assembly',
              },
              {
                name: 'STEAL-A-THON',
                date: 'NOV 9-10',
                icon: '🔥',
                path: '/hackathon/steal-a-thon',
              },
            ].map((event, i) => (
