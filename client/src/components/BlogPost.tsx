...
const BlogPost = ({ title, date, readTime, content }: BlogPostProps) => {
  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <article className="relative z-10 max-w-4xl mx-auto px-4 py-12 pt-24">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center gap-4 sm:gap-6 mb-8 text-white font-jetbrains">
          ...
          <Button
            ...
            size="sm"
            onClick={sharePost}
            className="ml-auto pixel-button bg-maximally-green hover:bg-maximally-green/90 text-white font-press-start text-xs px-3 py-2 rounded-none"
          >
  ...
  [&_p]:text-white
  [&_h1]:text-maximally-red 
  [&_h2]:text-maximally-yellow 
  [&_h3]:text-maximally-blue 
  [&_h4]:text-maximally-green
  [&_strong]:text-white 
  [&_em]:text-maximally-yellow 
  [&_a]:text-maximally-blue 
  [&_a:hover]:text-maximally-red 
  [&_code]:bg-gray-800 
  [&_code]:text-maximally-green 
  [&_pre]:bg-gray-900 
  [&_pre]:border 
  [&_pre]:border-gray-700 
  [&_blockquote]:border-l-4 
  [&_blockquote]:border-maximally-red 
  [&_blockquote]:bg-gray-800/60 
