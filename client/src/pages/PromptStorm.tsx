    ...
    <div className="min-h-screen bg-black">
      ...
      <div className="relative z-10">
        ...
        <section className="min-h-screen flex flex-col items-center justify-center relative px-4 pt-20">
          ...
          >
            <h1 className="font-space font-bold text-4xl md:text-6xl lg:text-7xl mb-6 bg-gradient-to-r from-blue-400 via-yellow-400 to-red-500 bg-clip-text text-transparent leading-tight">
              MAXIMALLY
              <br />
              PROMPTSTORM
            </h1>
            <h2 className="font-space text-xl md:text-2xl text-blue-400 mb-4">
              24 hour online prompt-engineering hackathon
            </h2>
            <p className="font-space font-bold text-lg md:text-xl text-yellow-400">
          ...
          >
            <Button
              ...
              className="pixel-button bg-gradient-to-r from-blue-500 to-blue-600 text-white font-space font-bold py-4 px-8 text-lg hover:scale-105 transition-all duration-300 border-2 border-yellow-400 shadow-xl"
            >
            ...
            <Button
              ...
              className="pixel-button bg-gradient-to-r from-gray-900 to-black text-yellow-400 font-space font-bold py-4 px-8 text-lg hover:scale-105 transition-all duration-300 border-2 border-blue-400 shadow-xl"
            >
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
              {fastFacts.map((fact, index) => (
                <div key={index} className="text-center group">
                  ...
                  <div className="font-space text-sm text-blue-400 font-bold">
                    {fact.value}
                  </div>
                </div>
              ))}
        ...
        <section className="py-20 px-4">
          <div className="container mx-auto max-w-4xl text-center">
            <h2 className="font-space font-bold text-3xl md:text-4xl mb-8 text-blue-400 flex items-center justify-center gap-3">
              <Zap className="h-8 w-8 text-yellow-400" />
              WHAT IT IS
              <Zap className="h-8 w-8 text-yellow-400" />
            </h2>
            <div className="bg-gradient-to-br from-blue-900/30 to-black p-8 rounded-lg border-2 border-blue-400">
              <p className="font-space text-lg md:text-xl text-white leading-relaxed">
              ...
              {whoJoins.map((person, index) => (
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <span className="font-space text-white font-medium">
                      {person}
                    </span>
                  </div>
                </div>
        ...
        <section className="py-20 px-4">
          <div className="container mx-auto max-w-5xl">
            <h2 className="font-space font-bold text-3xl md:text-4xl mb-12 text-blue-400 text-center flex items-center justify-center gap-3">
                ...
                >
                  <CardContent className="p-6">
                    <div className="flex items-start gap-4">
                      <div className="bg-gradient-to-r from-yellow-400 to-yellow-500 text-black w-12 h-12 rounded-full flex items-center justify-center font-space font-bold text-lg flex-shrink-0">
                        {step.step}
                      </div>
                      <div>
                        <div className="text-blue-400 mb-2">{step.icon}</div>
                        <p className="font-space text-white leading-relaxed">
                          {step.title}
                        </p>
                      </div>
                    </div>
          ...
          <div className="container mx-auto max-w-4xl">
            ...
            <div className="grid gap-4">
              {rules.map((rule, index) => (
                ...
                >
                  <div className="flex items-center gap-3">
                    <div className="w-6 h-6 bg-red-500 rounded-full flex items-center justify-center text-white font-space font-bold text-xs">
                      {index + 1}
                    </div>
                    <span className="font-space text-white">{rule}</span>
                  </div>
                </div>
              ))}
            </div>
              ...
              {timeline.map((item, index) => (
                ...
                >
                  <div className="text-center flex-shrink-0">
                    <div className="font-space font-bold text-lg text-yellow-400">
                      {item.date}
                    </div>
                    <div className="font-space text-sm text-blue-400">
                      {item.time}
                    </div>
                  </div>
                  <div className="w-px h-12 bg-gradient-to-b from-yellow-400 to-blue-400"></div>
                  <div className="font-space text-white text-lg">
                    {item.event}
                  </div>
                </div>
              ))}
        ...
        {/* Judging */}
        <section className="py-20 px-4 bg-gradient-to-b from-black via-gray-900/10 to-black">
          <div className="container mx-auto max-w-4xl">
            ...
            <div className="bg-gradient-to-br from-gray-900/30 to-black p-8 rounded-lg border-2 border-orange-500 mb-8">
              <h3 className="font-space font-bold text-xl text-yellow-400 mb-6">
                CRITERIA
              </h3>
              <div className="grid gap-4">
                {judgingCriteria.map((item, index) => (
                  ...
                  >
                    ...
                    <span className="font-space font-bold text-orange-400">
                      {item.weight}
                    </span>
                  </div>
                ))}
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-gradient-to-br from-green-900/30 to-black p-6 rounded-lg border-2 border-green-400">
                ...
                <ul className="space-y-3">
                  <li className="font-space text-white flex items-start gap-2">
              ...
              <div className="bg-gradient-to-br from-blue-900/30 to-black p-6 rounded-lg border-2 border-blue-400">
                <h3 className="font-space font-bold text-xl text-blue-400 mb-6 flex items-center gap-2">
