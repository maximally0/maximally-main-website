  ...
  const content = (
    <div className="space-y-6">
      ...
      <ul className="list-disc pl-6 space-y-2">
        <li>23% increase in advanced STEM course enrollment among makeathon participants</li>
        <li>18% improvement in project-based assignment scores across all subjects</li>
        <li>31% reduction in chronic absenteeism among previously disengaged students</li>
      ...
      <ul className="list-disc pl-6 space-y-2">
        <li>89% of participants report increased interest in innovation and entrepreneurship</li>
        <li>76% describe makeathon experiences as "among the most valuable" of their educational career</li>
        <li>82% continue working on project development after initial makeathon completion</li>
      ...
      <ul className="list-disc pl-6 space-y-2">
        <li>Enhanced familiarity with current technology trends and applications</li>
        <li>Improved project-based learning implementation in regular coursework</li>
        <li>Stronger connections with industry professionals and community partners</li>
      ...
      <ul className="list-disc pl-6 space-y-2">
        <li>Project-based learning modules in science and mathematics courses</li>
        <li>Entrepreneurship and innovation units in business and social studies classes</li>
        <li>Design thinking workshops in art and technology programs</li>
      ...
      <ul className="list-disc pl-6 space-y-2">
        <li>Technology and materials: $3,000-$5,000 for basic prototyping supplies and software licenses</li>
        <li>Professional development: $2,000-$3,000 for faculty training and ongoing support</li>
        <li>Event hosting: $1,000-$2,000 per event for venue, food, and basic logistics</li>
      ...
      <ul className="list-disc pl-6 space-y-2">
        <li>Annual software license renewals: $500-$1,000</li>
        <li>Replenishment of consumable materials: $1,000-$2,000</li>
        <li>Event hosting and logistics: $2,000-$4,000 annually</li>
      ...
      <ul className="list-disc pl-6 space-y-2">
        <li>Corporate sponsorship from local businesses seeking community engagement</li>
        <li>Grant funding from foundations focused on STEM education and innovation</li>
        <li>Fee-for-service consulting to other schools implementing similar programs</li>
...
export default SchoolInnovationROI;
