  ...
  const content = (
    <>
      ...
      <section className="my-8">
        ...
        <p className="mb-4 text-gray-100">But here's what most schools won't tell you:</p>
        ...
        <ul className="list-disc pl-6 space-y-2 mb-6 text-gray-100">
      ...
      <section className="my-8">
        ...
        <p className="mb-4 text-gray-100">No-code AI means building and using artificial intelligence tools without needing to know programming languages like Python or Java.</p>
        <div className="border-2 border-maximally-blue/30 bg-gray-900/50 p-4 sm:p-6 rounded-lg">
          <p className="mb-4 text-gray-100">Instead of writing lines of code, you can:</p>
      ...
      <section className="my-8">
        ...
        <div className="grid gap-6 mb-8">
          <div className="border-2 border-maximally-green/30 bg-gray-900/50 p-4 sm:p-6 rounded-lg">
            ...
            <p className="mb-2 text-gray-100">Use it to:</p>
            <ul className="list-disc pl-6 space-y-2 text-gray-100">
      ...
      <section className="my-8">
        ...
        <div className="grid gap-4">
          <div className="border-2 border-maximally-red/30 bg-gray-900/50 p-4 rounded-lg">
            ...
            <p className="text-gray-100">Created an AI bot that generates motivational messages for students dealing with exam stress.</p>
          </div>
          <div className="border-2 border-maximally-red/30 bg-gray-900/50 p-4 rounded-lg">
            <h3 className="font-press-start text-sm sm:text-lg text-maximally-yellow">🌟 Zoya, 16 (Pune)</h3>
            <p className="text-gray-100">Built an AI-powered news summarizer for teenagers—so they don't have to read long articles.</p>
          </div>
          <div className="border-2 border-maximally-red/30 bg-gray-900/50 p-4 rounded-lg">
            <h3 className="font-press-start text-sm sm:text-lg text-maximally-yellow">🌟 Krishna, 17 (Indore)</h3>
            <p className="text-gray-100">Runs a small business selling AI-generated logos to local shops.</p>
          </div>
        </div>
      </section>
      ...
      <section className="border-2 border-maximally-green bg-gray-900/50 p-4 sm:p-6 my-8 rounded-lg">
        ...
        <p className="mb-4 text-gray-100">Maximally is India's most hands-on AI bootcamp designed for teenagers—no coding needed.</p>
        <div className="mb-6">
      ...
      <section className="my-8">
        ...
        <p className="mb-4 text-gray-100">You don't need to be 18, a genius, or a coder to shape the future.</p>
        <p className="font-press-start text-md sm:text-lg mb-4 text-maximally-yellow">You just need to start.</p>
        <p className="mb-4 text-gray-100">And with AI, the future is already yours to build.</p>
        <p className="text-gray-100">So pick up that laptop. Launch your first idea.</p>
