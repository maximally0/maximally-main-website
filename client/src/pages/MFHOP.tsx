      ...
      <div className="min-h-screen bg-black text-white relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 z-10">
            <div className="max-w-5xl mx-auto text-center">
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-orange-500/10 border border-gray-800 mb-6">
                ...
                <span className="font-space font-bold text-[10px] sm:text-xs text-orange-400">MFHOP</span>
              </div>

              <h1 className="font-space font-bold text-xl sm:text-2xl md:text-3xl lg:text-4xl mb-4 leading-relaxed">
                <span className="bg-gradient-to-r from-orange-400 to-orange-500 bg-clip-text text-transparent">
                  MAXIMALLY FEDERATION
                </span>
              </h1>

              <h2 className="font-space font-bold text-sm sm:text-base md:text-lg text-gray-400 mb-6">
                OF HACKATHON ORGANIZERS AND PARTNERS
              </h2>

              <p className="text-gray-400 text-sm sm:text-base max-w-3xl mx-auto font-space leading-relaxed mb-8">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
                ...
                <button
                  ...
                  className="inline-flex items-center gap-2 px-8 py-4 bg-amber-500/20 border border-amber-500/40 hover:border-amber-400 text-amber-300 hover:text-amber-200 font-space font-bold text-xs transition-all duration-300"
                >
            ...
            <div className="max-w-4xl mx-auto">
              <div className="text-center mb-8">
                <div className="inline-flex items-center gap-2 px-4 py-2 bg-gray-800 border border-gray-700 mb-4">
                  ...
                  <span className="font-space font-bold text-[10px] sm:text-xs text-gray-300">ABOUT</span>
                </div>
                <h2 className="font-space font-bold text-lg sm:text-xl md:text-2xl text-white">
                  WHAT IS <span className="bg-gradient-to-r from-orange-400 to-orange-500 bg-clip-text text-transparent">MFHOP?</span>
                </h2>
              </div>

              <div className="bg-gradient-to-br from-gray-900/80 to-gray-900/40 border border-gray-800 p-8 text-center">
                <p className="font-space text-gray-300 text-sm sm:text-base leading-relaxed">
                  ...
                  <span className="text-orange-400 font-semibold"> Membership is free</span>, and open to any organizer who has hosted at least one hackathon.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-12">
                <div className="inline-flex items-center gap-2 px-4 py-2 bg-orange-500/5 border border-gray-800 mb-4">
                  ...
                  <span className="font-space font-bold text-[10px] sm:text-xs text-orange-400">BENEFITS</span>
                </div>
                <h2 className="font-space font-bold text-lg sm:text-xl md:text-2xl text-white">
                  HOW WE <span className="bg-gradient-to-r from-orange-400 to-orange-500 bg-clip-text text-transparent">HELP EACH OTHER</span>
                </h2>
              </div>
                ...
                {benefits.map((benefit, i) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <h3 className={`font-space font-bold text-xs ${c.text} mb-3`}>
              ...
              <div className="text-center">
                <p className="font-space font-bold text-sm text-orange-400">
            ...
            <div className="max-w-4xl mx-auto">
              <div className="text-center mb-12">
                <div className="inline-flex items-center gap-2 px-4 py-2 bg-amber-500/10 border border-amber-500/30 mb-4">
                  ...
                  <span className="font-space font-bold text-[10px] sm:text-xs text-amber-300">STRUCTURE</span>
                </div>
                <h2 className="font-space font-bold text-lg sm:text-xl md:text-2xl text-white">
              ...
              <div className="space-y-4">
                ...
                <div className="bg-gradient-to-br from-amber-500/10 to-orange-500/10 border border-amber-500/30 p-6">
                  <h3 className="font-space font-bold text-xs text-amber-300 mb-2">VICE PRESIDENTS</h3>
                  <p className="font-space text-white">Outreach, Partnerships, Community, Marketing</p>
                </div>

                <div className="bg-gradient-to-br from-green-500/10 to-emerald-500/10 border border-green-500/30 p-6">
                  <h3 className="font-space font-bold text-xs text-green-300 mb-2">COUNCIL</h3>
                  <p className="font-space text-white">Regional and Event Collaboration leads elected from members</p>
                </div>

                <div className="bg-gradient-to-br from-gray-900/40 to-gray-900/20 border border-gray-700 p-6">
                  <h3 className="font-space font-bold text-xs text-gray-300 mb-2">MEMBERS</h3>
                  <p className="font-space text-white">All approved hackathon organizers</p>
                </div>
              </div>

              <div className="text-center mt-8">
                <div className="bg-gradient-to-br from-gray-900/80 to-gray-900/40 border border-gray-800 p-6">
                  <p className="font-space font-bold text-xs text-orange-400">
            ...
            <div className="max-w-4xl mx-auto">
              <div className="text-center mb-12">
                <div className="inline-flex items-center gap-2 px-4 py-2 bg-green-500/10 border border-green-500/30 mb-4">
                  ...
                  <span className="font-space font-bold text-[10px] sm:text-xs text-green-300">REQUIREMENTS</span>
                </div>
                <h2 className="font-space font-bold text-lg sm:text-xl md:text-2xl text-white">
              ...
              <div className="space-y-4">
                {requirements.map((requirement, i) => (
                  <div key={i} className="bg-gradient-to-br from-green-500/10 to-emerald-500/10 border border-green-500/30 p-6 flex items-center gap-4">
                    ...
                    <p className="font-space text-gray-300 text-sm sm:text-base">
                      {requirement}
                    </p>
                  </div>
                ))}
            ...
            <div className="max-w-4xl mx-auto">
              <div className="text-center mb-12">
                <div className="inline-flex items-center gap-2 px-4 py-2 bg-gray-800 border border-gray-700 mb-4">
                  ...
                  <span className="font-space font-bold text-[10px] sm:text-xs text-gray-300">PROCESS</span>
                </div>
                <h2 className="font-space font-bold text-lg sm:text-xl md:text-2xl text-white">
                  HOW TO <span className="bg-gradient-to-r from-orange-400 to-blue-400 bg-clip-text text-transparent">JOIN</span>
                </h2>
              </div>

              <div className="space-y-4">
                {steps.map((step, i) => (
                  <div key={i} className="bg-gradient-to-br from-gray-900/40 to-gray-900/20 border border-gray-700 p-6 flex items-center gap-4">
                    <div className="bg-gray-800 border border-gray-700 w-10 h-10 flex items-center justify-center flex-shrink-0">
                      <span className="font-space font-bold text-sm text-gray-300">{i + 1}</span>
                    </div>
                    <p className="font-space text-gray-300 text-sm sm:text-base">
                      {step}
                    </p>
              ...
              <div className="text-center mt-12">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 px-8 py-4 bg-gradient-to-r from-orange-600 to-orange-500 border border-orange-500/50 hover:border-orange-500 text-white hover:text-white font-space font-bold text-xs transition-all duration-300"
                >
                  <FileText className="h-4 w-4" />
                  APPLY NOW
            ...
            <div className="max-w-4xl mx-auto">
              <div className="text-center mb-12">
                <div className="inline-flex items-center gap-2 px-4 py-2 bg-orange-500/5 border border-gray-800 mb-4">
                  ...
                  <span className="font-space font-bold text-[10px] sm:text-xs text-orange-400">QUESTIONS</span>
                </div>
                <h2 className="font-space font-bold text-lg sm:text-xl md:text-2xl text-white">
                  <span className="bg-gradient-to-r from-orange-400 to-orange-500 bg-clip-text text-transparent">FAQ</span>
                </h2>
              </div>

              <div className="space-y-4">
                <div className="bg-gradient-to-br from-gray-900/80 to-gray-900/40 border border-gray-800 p-6">
                  <h3 className="font-space font-bold text-xs text-orange-400 mb-3">IS THERE A FEE?</h3>
                  <p className="font-space text-gray-300">No, membership is free.</p>
                </div>

                <div className="bg-gradient-to-br from-amber-500/10 to-orange-500/10 border border-amber-500/30 p-6">
                  <h3 className="font-space font-bold text-xs text-amber-300 mb-3">WHO CAN JOIN?</h3>
                  <p className="font-space text-gray-300">Any team or organizer that has hosted a hackathon.</p>
                </div>

                <div className="bg-gradient-to-br from-green-500/10 to-emerald-500/10 border border-green-500/30 p-6">
                  <h3 className="font-space font-bold text-xs text-green-300 mb-3">WHAT IF WE'RE SMALL?</h3>
                  <p className="font-space text-gray-300">Size doesn't matter. What matters is you've actually run an event.</p>
                </div>

                <div className="bg-gradient-to-br from-gray-900/40 to-gray-900/20 border border-gray-700 p-6">
                  <h3 className="font-space font-bold text-xs text-gray-300 mb-3">WHAT'S IN IT FOR MAXIMALLY?</h3>
                  <p className="font-space text-gray-300">We're building the ecosystem and leading the initiative. Stronger organizers = stronger hackathons for everyone.</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="max-w-4xl mx-auto">
              <div className="p-8 sm:p-12 bg-gradient-to-br from-gray-900/40 via-black to-gray-900/20 border border-gray-800 text-center relative overflow-hidden">
                ...
                <div className="relative z-10">
                  <h2 className="font-space font-bold text-base sm:text-lg md:text-xl text-white mb-6">
                    READY TO JOIN THE <span className="bg-gradient-to-r from-orange-400 to-orange-500 bg-clip-text text-transparent">FEDERATION?</span>
                  </h2>
                  ...
                  <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-8">
                    ...
                    <span className="text-gray-500 font-space font-bold text-xs">OR</span>
                  ...
                  <div className="bg-black/40 border border-gray-800 p-4">
                    <p className="font-space text-gray-400 text-sm">
                      Learn more at <span className="text-orange-400">maximally.in/mfhop</span> | Contact us at <span className="text-orange-400">cal.com/maximally</span>
                    </p>
                  </div>
                </div>
              </div>
        ...
        {showEmailModal && (
          <div className="fixed inset-0 bg-black/80 backdrop-blur-sm flex items-center justify-center z-50 p-4">
            <div className="bg-gradient-to-br from-gray-900/50 via-black to-gray-900/40 border border-gray-800 p-8 max-w-md w-full relative">
              <button
                onClick={() => setShowEmailModal(false)}
                className="absolute top-4 right-4 bg-orange-500/10 border border-orange-500/30 p-2 hover:bg-orange-500/20 transition-colors"
              >
              ...
              <div className="text-center">
                ...
                <h3 className="font-space font-bold text-sm text-orange-400 mb-4">
                  CONTACT MFHOP
                </h3>
                ...
                <div className="bg-black/40 border border-amber-500/30 p-4 mb-6">
                  <p className="font-space text-amber-300 text-lg break-all">
                    mfhop@maximally.in
                  </p>
                </div>
                ...
                <button
                  onClick={copyEmail}
                  className="inline-flex items-center gap-2 px-6 py-3 bg-amber-500/20 border border-amber-500/40 hover:border-amber-400 text-amber-300 hover:text-amber-200 font-space font-bold text-xs transition-all duration-300"
                >
                ...
                {copied && (
                  <p className="font-space text-green-400 text-sm mt-3">
