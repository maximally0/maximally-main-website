      ...
      <div className="pt-24 px-4 pb-12 relative z-10">
        <div className="container mx-auto max-w-4xl">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-orange-500/10 border border-gray-800 mb-6">
            ...
            <span className="font-space font-bold text-[10px] sm:text-xs text-orange-400">LEGAL</span>
          </div>
          ...
          <p className="font-space text-sm text-gray-500 mb-8">
            Last updated: 14-11-2025
          </p>
          
          <div className="font-space space-y-8">
            ...
            <section className="bg-gradient-to-br from-orange-500/5 to-orange-500/5 border border-gray-800 p-6">
              <h2 className="font-space font-bold text-sm mb-3 text-orange-400">2. Scope</h2>
              <p className="leading-relaxed text-gray-300">
            ...
            <section className="bg-gradient-to-br from-orange-500/5 to-orange-500/5 border border-gray-800 p-6">
              <h2 className="font-space font-bold text-sm mb-3 text-orange-400">3. Definitions</h2>
            ...
            <section className="bg-gradient-to-br from-orange-500/5 to-orange-500/5 border border-gray-800 p-6">
              <h2 className="font-space font-bold text-sm mb-3 text-orange-400">4. Information We Collect</h2>
            ...
            <section className="bg-gradient-to-br from-orange-500/5 to-orange-500/5 border border-gray-800 p-6">
              <h2 className="font-space font-bold text-sm mb-3 text-orange-400">5. How We Use Your Information</h2>
            ...
            <section className="bg-gradient-to-br from-orange-500/5 to-orange-500/5 border border-gray-800 p-6">
              <h2 className="font-space font-bold text-sm mb-3 text-orange-400">6. Legal Basis (for EU/Global Users)</h2>
              <p className="leading-relaxed text-gray-300">
            ...
            <section className="bg-gradient-to-br from-orange-500/5 to-orange-500/5 border border-gray-800 p-6">
              <h2 className="font-space font-bold text-sm mb-3 text-orange-400">7. Disclosure of Your Information</h2>
            ...
            <section className="bg-gradient-to-br from-orange-500/5 to-orange-500/5 border border-gray-800 p-6">
              <h2 className="font-space font-bold text-sm mb-3 text-orange-400">8. Cookies & Tracking Technologies</h2>
              <p className="leading-relaxed text-gray-300">
            ...
            <section className="bg-gradient-to-br from-orange-500/5 to-orange-500/5 border border-gray-800 p-6">
              <h2 className="font-space font-bold text-sm mb-3 text-orange-400">9. Data Security</h2>
              <p className="leading-relaxed text-gray-300">
            ...
            <section className="bg-gradient-to-br from-orange-500/5 to-orange-500/5 border border-gray-800 p-6">
              <h2 className="font-space font-bold text-sm mb-3 text-orange-400">10. Data Retention</h2>
              <p className="leading-relaxed text-gray-300">
            ...
            <section className="bg-gradient-to-br from-orange-500/5 to-orange-500/5 border border-gray-800 p-6">
              <h2 className="font-space font-bold text-sm mb-3 text-orange-400">11. Your Rights</h2>
            ...
            <section className="bg-gradient-to-br from-orange-500/5 to-orange-500/5 border border-gray-800 p-6">
              <h2 className="font-space font-bold text-sm mb-3 text-orange-400">12. Children's Information</h2>
              <p className="leading-relaxed text-gray-300">
            ...
            <section className="bg-gradient-to-br from-orange-500/5 to-orange-500/5 border border-gray-800 p-6">
              <h2 className="font-space font-bold text-sm mb-3 text-orange-400">13. International Transfers</h2>
              <p className="leading-relaxed text-gray-300">
            ...
            <section className="bg-gradient-to-br from-orange-500/5 to-orange-500/5 border border-gray-800 p-6">
              <h2 className="font-space font-bold text-sm mb-3 text-orange-400">14. Links to Other Websites</h2>
              <p className="leading-relaxed text-gray-300">
            ...
            <section className="bg-gradient-to-br from-orange-500/5 to-orange-500/5 border border-gray-800 p-6">
              <h2 className="font-space font-bold text-sm mb-3 text-orange-400">15. Changes to This Privacy Policy</h2>
              <p className="leading-relaxed text-gray-300">
            ...
            <section className="bg-gradient-to-br from-orange-500/5 to-orange-500/5 border border-gray-800 p-6">
              <h2 className="font-space font-bold text-sm mb-3 text-orange-400">16. Contact Us</h2>
              <p className="leading-relaxed text-gray-300">
