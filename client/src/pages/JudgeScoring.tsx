    ...
    return (
      <div className="min-h-screen bg-black text-white flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="font-space text-gray-400">Verifying your scoring access...</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="min-h-screen bg-black text-white flex items-center justify-center">
        ...
        <div className="text-center max-w-md mx-auto px-4">
          ...
          <h1 className="font-space font-bold text-xl mb-4 text-white">
          ...
          <a 
            href="/"
            className="inline-block bg-gradient-to-r from-orange-600 to-orange-500 text-white px-6 py-3 font-space font-bold text-xs hover:from-orange-500 hover:to-orange-500 transition-all"
          >
            GO_HOME
          </a>
        </div>
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-black text-white relative">
        ...
        <div className="fixed inset-0 pointer-events-none bg-gradient-to-br from-orange-500/10 via-transparent to-orange-500/10" />
        
        {/* Glowing Orbs */}
        <div className="fixed top-1/4 left-1/4 w-[400px] h-[400px] bg-orange-500/10 rounded-full blur-[150px] animate-pulse pointer-events-none" />
        <div className="fixed bottom-1/4 right-1/4 w-[350px] h-[350px] bg-orange-500/5 rounded-full blur-[120px] animate-pulse pointer-events-none" style={{ animationDelay: '1s' }} />
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-5xl mx-auto">
              ...
              <div className="flex items-center gap-3 mb-4">
                <div className="w-10 h-10 bg-gradient-to-br from-orange-500 to-orange-500 rounded-full flex items-center justify-center">
                  <Trophy className="h-5 w-5 text-white" />
                </div>
                <div>
                  <p className="text-sm text-gray-400 font-space">Welcome, Judge</p>
                  <p className="font-space font-bold text-sm text-white">{judge.name}</p>
                </div>
              </div>

              {/* Hackathon Title */}
              <h1 className="font-space font-bold text-2xl sm:text-3xl md:text-4xl mb-4 bg-gradient-to-r from-orange-400 to-orange-500 bg-clip-text text-transparent">
                {hackathon.title}
              </h1>

              {/* Progress Stats */}
              <div className="bg-gradient-to-br from-gray-900/80 to-gray-800/50 border border-gray-800 p-4 rounded-lg backdrop-blur-sm">
                <div className="flex items-center justify-between mb-3">
                  <span className="font-space text-gray-400 text-sm">Scoring Progress</span>
                ...
                <div className="w-full h-3 bg-gray-800 rounded-full overflow-hidden">
                  <div 
                    className="h-full bg-gradient-to-r from-orange-500 to-orange-500 transition-all duration-500"
                ...
                {stats.scored === stats.total && stats.total > 0 && (
                  <div className="flex items-center gap-2 mt-3 text-green-400">
                    ...
                    <span className="font-space text-sm">All submissions scored!</span>
                  </div>
                )}
              </div>
            </div>
            ...
            <div className="max-w-5xl mx-auto">
              {submissions.length === 0 ? (
                <div className="text-center py-16">
                  ...
                  <h2 className="font-space font-bold text-lg mb-2 text-gray-400">No Submissions Yet</h2>
