          ...
          <div className="space-y-6">
            <div className="bg-gradient-to-br from-green-500/10 to-emerald-500/10 border border-green-500/30 p-8 backdrop-blur-sm">
              ...
              <h1 className="font-space font-bold text-xl sm:text-2xl md:text-3xl mb-4">
                <span className="bg-gradient-to-r from-green-400 via-gray-500 to-orange-400 bg-clip-text text-transparent">
                  Thank you for applying!
                </span>
              </h1>
              <p className="font-space text-base sm:text-lg text-gray-300">
                We've received your application and our team will review it thoroughly.
              </p>
            </div>
            
            <p className="font-space text-base sm:text-lg text-gray-400">
          ...
          <div className="grid gap-4 md:grid-cols-2 text-left">
            <div className="bg-gradient-to-br from-gray-900/40 to-gray-900/20 border border-gray-700 p-6">
              <div className="flex items-center gap-3 mb-3">
                <div className="bg-gray-800 border border-gray-700 w-8 h-8 flex items-center justify-center">
                  <Brain className="h-4 w-4 text-gray-300" />
                </div>
                <h3 className="font-space font-bold text-xs text-gray-300">Be Authentic</h3>
              </div>
            ...
            <div className="bg-gradient-to-br from-gray-900/40 to-gray-900/20 border border-gray-800 p-6">
              <div className="flex items-center gap-3 mb-3">
                <div className="bg-orange-500/10 border border-orange-500/30 w-8 h-8 flex items-center justify-center">
                  <Lightbulb className="h-4 w-4 text-orange-400" />
                </div>
                <h3 className="font-space font-bold text-xs text-orange-400">Brush Up Basics</h3>
              </div>
              <p className="font-space text-sm text-gray-400">
            ...
            <div className="bg-gradient-to-br from-green-500/10 to-emerald-500/10 border border-green-500/30 p-6">
              <div className="flex items-center gap-3 mb-3">
                ...
                <h3 className="font-space font-bold text-xs text-green-300">Keep it Chill</h3>
              </div>
              <p className="font-space text-sm text-gray-400">
            ...
            <div className="bg-gradient-to-br from-orange-500/10 to-violet-500/10 border border-gray-800 p-6">
              <div className="flex items-center gap-3 mb-3">
                ...
                <h3 className="font-space font-bold text-xs text-orange-400">Bring Questions</h3>
              </div>
              <p className="font-space text-sm text-gray-400">
