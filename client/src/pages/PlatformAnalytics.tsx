  ...
  return (
    <>
      <SEO
        ...
        keywords="platform analytics, builder insights, hackathon data, technology trends, Maximally analytics, hackathon analytics, developer insights"
      />
          ...
          <div className="container mx-auto px-4 sm:px-6">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
              <div className="bg-gradient-to-br from-gray-900/60 to-gray-900/30 border border-gray-800 p-6">
                <div className="p-3 bg-gray-800 border border-blue-500/40 w-fit mb-4">
                  <Code className="h-6 w-6 text-blue-400" />
                </div>
                <h3 className="font-space font-bold text-xs text-white mb-2">TECH STACK</h3>
              ...
              <div className="bg-gradient-to-br from-gray-900/60 to-gray-900/30 border border-gray-800 p-6">
                ...
                <h3 className="font-space font-bold text-xs text-white mb-2">TRENDS</h3>
                <p className="font-space text-sm text-gray-400">
              ...
              <div className="bg-gradient-to-br from-gray-900/60 to-gray-900/30 border border-gray-800 p-6">
                <div className="p-3 bg-orange-500/10 border border-orange-500/30 w-fit mb-4">
                  <Layers className="h-6 w-6 text-orange-400" />
                </div>
                <h3 className="font-space font-bold text-xs text-white mb-2">DOMAINS</h3>
                <p className="font-space text-sm text-gray-400">
