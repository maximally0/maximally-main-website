    ...
    <div className="min-h-screen pt-20 md:pt-24">
      ...
      <div className="bg-black text-white py-4 px-4 text-center relative overflow-hidden">
        ...
        <div className="container mx-auto relative">
          <p className="font-space font-bold text-sm md:text-base mb-2">
            <strong>This event has ended.</strong>
          </p>
          <p className="font-space text-xs md:text-sm text-white/80">
      ...
      <section className="bg-white py-6 sm:py-16 px-3 sm:px-4 relative">
        {/* Archived Label */}
        <div className="absolute top-4 right-4 bg-gray-800 text-white px-3 py-1 rounded-full text-xs font-space">
        ...
        <div className="container mx-auto text-center">
          ...
          <div className="mt-8 mb-12">
            <Link 
              to="/"
              className="pixel-button bg-[#39FF14] text-black px-12 py-6 text-xl font-space font-bold hover:scale-105 transform transition-all shadow-xl"
            >
              Back to Home →
            </Link>
      ...
      <section className="py-8 sm:py-12 px-3 sm:px-4 bg-gray-50">
        <div className="container mx-auto text-center">
          <h2 className="font-space font-bold text-2xl sm:text-3xl mb-6 sm:mb-8">🏆 What Participants Got</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 md:gap-6 px-2 sm:px-4 md:px-0">
            <Card className="border-2 border-[#39FF14]/30 hover:border-[#39FF14] transition-all">
              <CardContent className="p-6">
                ...
                <p className="font-space">Built something real — not just theory</p>
              </CardContent>
            </Card>
            <Card className="border-2 border-[#FF5F5F]/30 hover:border-[#FF5F5F] transition-all">
              <CardContent className="p-6">
                ...
                <p className="font-space">Top performers got placed in real startups</p>
              </CardContent>
            </Card>
            <Card className="border-2 border-[#B400FF]/30 hover:border-[#B400FF] transition-all">
              <CardContent className="p-6">
                ...
                <p className="font-space">₹5K-₹10K to help continue building</p>
              </CardContent>
            </Card>
            ...
            <Card className="border-2 border-[#FF5F5F]/30 hover:border-[#FF5F5F] transition-all">
              <CardContent className="p-6">
                ...
                <p className="font-space">Guidance through next steps</p>
              </CardContent>
            </Card>
            <Card className="border-2 border-[#B400FF]/30 hover:border-[#B400FF] transition-all">
              <CardContent className="p-6">
      ...
      <section className="py-12 px-4 bg-gray-50">
        <div className="container mx-auto text-center">
          <h2 className="font-space font-bold text-3xl mb-8">👥 Who Participated</h2>
      ...
      <section className="py-12 px-4 bg-gray-50">
        <div className="container mx-auto">
          <h2 className="font-space font-bold text-3xl mb-8 text-center">📚 The 7-Day Builder Journey</h2>
        ...
        <div className="container mx-auto relative">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
            <div className="bg-black/40 p-6 rounded-lg border-2 border-[#39FF14] hover:scale-105 transform transition-all duration-300">
              ...
              <p className="font-space text-white">Real-life challenges and lessons from top founders, creators, and VCs who dropped by to share their journeys.</p>
            </div>
            ...
            <div className="bg-black/40 p-6 rounded-lg border-2 border-[#00ff99] hover:scale-105 transform transition-all duration-300">
              ...
              <p className="font-space text-white">Worked in small, dynamic startup teams to build and iterate ideas with fellow ambitious teens. Teams worked like real startups. They brainstormed, built, and shipped daily.</p>
            </div>
            ...
            <div className="bg-black/40 p-6 rounded-lg border-2 border-[#00ffcc] hover:scale-105 transform transition-all duration-300">
              ...
              <p className="font-space text-white">Pitched projects to secure potential internships and funding to continue growth journeys. Pitched to founders, creators, and VCs — live.</p>
            </div>
          </div>
          ...
          <div className="mb-12">
            ...
            <div className="space-y-6 relative">
              <div className="bg-black/40 p-6 rounded-lg border-2 border-[#39FF14] hover:border-[#39FF14] transition-all duration-300 transform hover:-translate-y-1 hover:shadow-[0_0_25px_rgba(57,255,20,0.5)]">
                ...
                <p className="font-space text-white">Each afternoon kicked off with a challenge, a guest founder, or a mind-bending activity.</p>
              </div>
              <div className="bg-black/40 p-6 rounded-lg border-2 border-[#00FFFF] hover:border-[#00FFFF] transition-all duration-300 transform hover:-translate-y-1 hover:shadow-[0_0_25px_rgba(0,255,255,0.5)]">
                ...
                <p className="font-space text-white">Founders, creators, VCs, and domain experts dropped in daily. No fluff — just real stories and execution playbooks.</p>
              </div>
              <div className="bg-black/40 p-6 rounded-lg border-2 border-[#FF00FF] hover:border-[#FF00FF] transition-all duration-300 transform hover:-translate-y-1 hover:shadow-[0_0_25px_rgba(255,0,255,0.5)]">
                ...
                <p className="font-space text-white">Participants were sorted into guilds of 4–5 teens. Think startup team meets secret society. They built together, debated together, and shipped real things — every day.</p>
              </div>
              <div className="bg-black/40 p-6 rounded-lg border-2 border-[#FFA500] hover:border-[#FFA500] transition-all duration-300 transform hover:-translate-y-1 hover:shadow-[0_0_25px_rgba(255,165,0,0.5)]">
                ...
                <p className="font-space text-white">They didn't just learn — they <i>did</i>. Built ideas. Designed MVPs. Crafted pitches. Got feedback. Repeated.</p>
              </div>
              <div className="bg-black/40 p-6 rounded-lg border-2 border-[#FF3366] hover:border-[#FF3366] transition-all duration-300 transform hover:-translate-y-1 hover:shadow-[0_0_25px_rgba(255,51,102,0.5)]">
                ...
                <p className="font-space text-white">They got curated mini-reads and videos from legends — stuff you won't find in textbooks. (<i>Think Naval Ravikant, Ali Abdaal, Sahil Bloom, Notion, Figma, ChatGPT.</i>)</p>
              </div>
              <div className="bg-black/40 p-6 rounded-lg border-2 border-[#9966FF] hover:border-[#9966FF] transition-all duration-300 transform hover:-translate-y-1 hover:shadow-[0_0_25px_rgba(153,102,255,0.5)]">
                ...
                <p className="font-space text-white">Complete challenges, win debates, impress mentors — earn XP and badges. Top builders unlocked real perks and recognition.</p>
              </div>
              <div className="bg-black/40 p-6 rounded-lg border-2 border-[#00FF99] hover:border-[#00FF99] transition-all duration-300 transform hover:-translate-y-1 hover:shadow-[0_0_25px_rgba(0,255,153,0.5)]">
                ...
                <p className="font-space text-white">On Day 7, guilds pitched in front of a live panel. No pressure. Just their first real founder moment.</p>
              </div>
            </div>
          </div>
          ...
          <div className="mb-12">
            ...
            <div className="grid grid-cols-1 gap-4">
              ...
              <div className="bg-black/40 p-4 rounded-lg border-2 border-[#00FFFF] hover:border-[#00FFFF] transition-all duration-300 transform hover:scale-105 hover:shadow-[0_0_25px_rgba(0,255,255,0.5)]">
                <p className="font-space text-[#00FFFF]">✅ Internship and funding opportunities if they had a viable idea</p>
              </div>
              ...
              <div className="bg-black/40 p-4 rounded-lg border-2 border-[#39FF14] hover:border-[#39FF14] transition-all duration-300 transform hover:scale-105 hover:shadow-[0_0_25px_rgba(57,255,20,0.5)]">
                <p className="font-space text-[#39FF14]">✅ Confidence that stays with them as they move forward in their careers</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto">
          ...
          <Accordion type="single" collapsible className="w-full">
            <AccordionItem value="faq1">
              <AccordionTrigger className="font-space font-bold">Did participants need to know how to code?</AccordionTrigger>
              <AccordionContent className="font-space">
                Nope! We covered AI & no-code tools that anyone could use.
              </AccordionContent>
            </AccordionItem>
            <AccordionItem value="faq2">
              <AccordionTrigger className="font-space font-bold">What about shy or introverted participants?</AccordionTrigger>
              <AccordionContent className="font-space">
                They were welcome. We helped them build confidence, not just skills.
              </AccordionContent>
            </AccordionItem>
            <AccordionItem value="faq3">
              <AccordionTrigger className="font-space font-bold">Was this only for kids from big cities?</AccordionTrigger>
              <AccordionContent className="font-space">
                Not at all. We had students from small towns around the world. All that mattered was ambition.
              </AccordionContent>
            </AccordionItem>
            <AccordionItem value="faq9">
              <AccordionTrigger className="font-space font-bold">What if someone had never built anything before?</AccordionTrigger>
              <AccordionContent className="font-space">
                Perfect — we showed them how. No experience needed. Just curiosity and willingness to try.
              </AccordionContent>
            </AccordionItem>
            <AccordionItem value="faq10">
              <AccordionTrigger className="font-space font-bold">What was a "guild"?</AccordionTrigger>
              <AccordionContent className="font-space">
            ...
            <AccordionItem value="faq11">
              <AccordionTrigger className="font-space font-bold">Were there homework or assignments?</AccordionTrigger>
              <AccordionContent className="font-space">
            ...
            <AccordionItem value="faq12">
              <AccordionTrigger className="font-space font-bold">Did participants get to meet speakers and mentors?</AccordionTrigger>
              <AccordionContent className="font-space">
            ...
            <AccordionItem value="faq13">
              <AccordionTrigger className="font-space font-bold">What happened after the bootcamp ended?</AccordionTrigger>
              <AccordionContent className="font-space">
            ...
            <AccordionItem value="faq4">
              <AccordionTrigger className="font-space font-bold">Did participants get personal feedback or help?</AccordionTrigger>
              <AccordionContent className="font-space">
                Yes. They had mentors, peers, and our team to guide them.
              </AccordionContent>
            </AccordionItem>
            <AccordionItem value="faq5">
              <AccordionTrigger className="font-space font-bold">What happened after the Makeathon ended?</AccordionTrigger>
              <AccordionContent className="font-space">
                They joined a lifelong alumni network with exclusive access to events, internships, and more.
              </AccordionContent>
            </AccordionItem>
            <AccordionItem value="faq14">
              <AccordionTrigger className="font-space font-bold">Was this a hackathon or a bootcamp?</AccordionTrigger>
              <AccordionContent className="font-space">
      ...
      <section className="py-12 px-4 bg-gradient-to-b from-black via-gray-900 to-black relative overflow-hidden">
        ...
        <div className="container mx-auto text-center relative">
          <h2 className="font-space font-bold text-3xl mb-8 text-white">🏫 Our Partner Schools</h2>
