      ...
      <div className="pt-24 px-4 pb-12 relative z-10">
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="font-space space-y-8">
            ...
            <section className="bg-gradient-to-br from-orange-500/5 to-orange-500/5 border border-gray-800 p-6">
              <h2 className="font-space font-bold text-sm mb-3 text-orange-400">2. Definitions</h2>
            ...
            <section className="bg-gradient-to-br from-orange-500/5 to-orange-500/5 border border-gray-800 p-6">
              <h2 className="font-space font-bold text-sm mb-3 text-orange-400">3. Use of the Website</h2>
            ...
            <section className="bg-gradient-to-br from-orange-500/5 to-orange-500/5 border border-gray-800 p-6">
              <h2 className="font-space font-bold text-sm mb-3 text-orange-400">4. Intellectual Property</h2>
            ...
            <section className="bg-gradient-to-br from-orange-500/5 to-orange-500/5 border border-gray-800 p-6">
              <h2 className="font-space font-bold text-sm mb-3 text-orange-400">5. User Accounts</h2>
            ...
            <section className="bg-gradient-to-br from-orange-500/5 to-orange-500/5 border border-gray-800 p-6">
              <h2 className="font-space font-bold text-sm mb-3 text-orange-400">6. Orders, Payment & Delivery</h2>
              <ul className="space-y-2 leading-relaxed list-disc list-inside text-gray-300">
            ...
            <section className="bg-gradient-to-br from-orange-500/5 to-orange-500/5 border border-gray-800 p-6">
              <h2 className="font-space font-bold text-sm mb-3 text-orange-400">7. Refunds / Returns / Cancellations</h2>
              <p className="leading-relaxed mb-2 text-gray-300">
            ...
            <section className="bg-gradient-to-br from-orange-500/5 to-orange-500/5 border border-gray-800 p-6">
              <h2 className="font-space font-bold text-sm mb-3 text-orange-400">8. Disclaimer of Warranties</h2>
              <p className="leading-relaxed mb-2 text-gray-300">
            ...
            <section className="bg-gradient-to-br from-orange-500/5 to-orange-500/5 border border-gray-800 p-6">
              <h2 className="font-space font-bold text-sm mb-3 text-orange-400">9. Limitation of Liability</h2>
              <p className="leading-relaxed mb-2 text-gray-300">
            ...
            <section className="bg-gradient-to-br from-orange-500/5 to-orange-500/5 border border-gray-800 p-6">
              <h2 className="font-space font-bold text-sm mb-3 text-orange-400">10. Indemnification</h2>
              <p className="leading-relaxed text-gray-300">
            ...
            <section className="bg-gradient-to-br from-orange-500/5 to-orange-500/5 border border-gray-800 p-6">
              <h2 className="font-space font-bold text-sm mb-3 text-orange-400">11. Links to Third-Party Sites</h2>
              <p className="leading-relaxed text-gray-300">
            ...
            <section className="bg-gradient-to-br from-orange-500/5 to-orange-500/5 border border-gray-800 p-6">
              <h2 className="font-space font-bold text-sm mb-3 text-orange-400">12. Privacy</h2>
              <p className="leading-relaxed text-gray-300">
            ...
            <section className="bg-gradient-to-br from-orange-500/5 to-orange-500/5 border border-gray-800 p-6">
              <h2 className="font-space font-bold text-sm mb-3 text-orange-400">13. Modification of Terms</h2>
              <p className="leading-relaxed text-gray-300">
            ...
            <section className="bg-gradient-to-br from-orange-500/5 to-orange-500/5 border border-gray-800 p-6">
              <h2 className="font-space font-bold text-sm mb-3 text-orange-400">14. Governing Law & Jurisdiction</h2>
              <p className="leading-relaxed text-gray-300">
            ...
            <section className="bg-gradient-to-br from-orange-500/5 to-orange-500/5 border border-gray-800 p-6">
              <h2 className="font-space font-bold text-sm mb-3 text-orange-400">15. Contact Us</h2>
              <p className="leading-relaxed text-gray-300">
