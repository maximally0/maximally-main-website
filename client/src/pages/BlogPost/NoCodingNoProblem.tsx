...
const NoCodingNoProblem = () => {
  const content = (
    <div className="space-y-6">
      ...
      <h2 className="text-2xl font-space font-bold text-maximally-black mt-8 mb-4">Breaking the Coding Myth: Why Non-Tech Teens Excel at Makeathons</h2>
      
      <h3 className="text-xl font-space font-bold text-maximally-blue mt-6 mb-3">The Advantage of Fresh Perspectives</h3>
      <p>
      ...
      <h3 className="text-xl font-space font-bold text-maximally-blue mt-6 mb-3">Real Success Stories from Non-Coders</h3>
      <p>
      ...
      <h2 className="text-2xl font-space font-bold text-maximally-black mt-8 mb-4">The No-Code Revolution: Your Gateway to Tech Entrepreneurship</h2>

      <h3 className="text-xl font-space font-bold text-maximally-blue mt-6 mb-3">What Is No-Code Development?</h3>
      <p>
      ...
      <h3 className="text-xl font-space font-bold text-maximally-blue mt-6 mb-3">Key Benefits for Beginners:</h3>
      <ul className="list-disc pl-6 space-y-2">
      ...
      <h2 className="text-2xl font-space font-bold text-maximally-black mt-8 mb-4">Essential No-Code Tools Taught at Maximally</h2>

      <h3 className="text-xl font-space font-bold text-maximally-blue mt-6 mb-3">Web Application Development:</h3>
      <ul className="list-disc pl-6 space-y-2">
      ...
      <h3 className="text-xl font-space font-bold text-maximally-blue mt-6 mb-3">Mobile App Creation:</h3>
      <ul className="list-disc pl-6 space-y-2">
      ...
      <h3 className="text-xl font-space font-bold text-maximally-blue mt-6 mb-3">AI Integration:</h3>
      <ul className="list-disc pl-6 space-y-2">
      ...
      <h2 className="text-2xl font-space font-bold text-maximally-black mt-8 mb-4">Day-by-Day Learning Journey for Non-Technical Participants</h2>

      <h3 className="text-xl font-space font-bold text-maximally-blue mt-6 mb-3">Day 1: Mindset Shift and Tool Introduction</h3>
      <p>
      ...
      <h3 className="text-xl font-space font-bold text-maximally-blue mt-6 mb-3">Day 2: Problem Identification and Validation</h3>
      <p>
      ...
      <h3 className="text-xl font-space font-bold text-maximally-blue mt-6 mb-3">Day 3-4: Building Your MVP</h3>
      <p>
      ...
      <h3 className="text-xl font-space font-bold text-maximally-blue mt-6 mb-3">Day 5-6: Testing and Iteration</h3>
      <p>
      ...
      <h3 className="text-xl font-space font-bold text-maximally-blue mt-6 mb-3">Day 7: Launch and Pitch Preparation</h3>
      <p>
      ...
      <h2 className="text-2xl font-space font-bold text-maximally-black mt-8 mb-4">Skills You'll Develop Beyond No-Code Tools</h2>

      <h3 className="text-xl font-space font-bold text-maximally-blue mt-6 mb-3">Business Acumen</h3>
      <ul className="list-disc pl-6 space-y-2">
      ...
      <h3 className="text-xl font-space font-bold text-maximally-blue mt-6 mb-3">Communication Skills</h3>
      <ul className="list-disc pl-6 space-y-2">
      ...
      <h2 className="text-2xl font-space font-bold text-maximally-black mt-8 mb-4">Building Confidence: From Intimidation to Innovation</h2>
