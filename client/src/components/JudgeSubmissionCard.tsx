        ...
        <div className="flex items-center gap-4 flex-1 min-w-0">
          ...
          <div className={`w-10 h-10 rounded-lg flex items-center justify-center flex-shrink-0 ${
            ...
            {hasScore ? (
              ...
              <span className="font-space font-bold text-xs">{index}</span>
            )}
          </div>
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex items-center gap-3 mt-1">
              {hasScore && (
                <span className="font-space text-xs text-green-400">
                  Score: {submission.score!.score}/10
                </span>
              )}
              {!hasScore && (
                <span className="font-space text-xs text-amber-400">
                  Not scored
                </span>
              )}
            </div>
          ...
          <div className="hidden sm:flex items-center gap-2">
            {submission.demo_url && (
              <a
                ...
                className="p-2 bg-gray-800 text-gray-300 rounded hover:bg-gray-800/30 transition-colors"
                title="View Demo"
              >
      ...
      {isExpanded && (
        <div className="border-t border-gray-700/50 p-4 space-y-4">
          ...
          {submission.project_description && (
            <div>
              <h4 className="font-space font-bold text-xs text-gray-400 mb-2">DESCRIPTION</h4>
              <p className="font-space text-sm text-gray-300 whitespace-pre-wrap">
                {submission.project_description}
              </p>
            </div>
          )}
          ...
          <div className="sm:hidden">
            <h4 className="font-space font-bold text-xs text-gray-400 mb-2">LINKS</h4>
            <div className="flex flex-wrap gap-2">
              {submission.demo_url && (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 px-3 py-2 bg-gray-800 text-gray-300 rounded text-sm font-space hover:bg-gray-800/30 transition-colors"
                >
                  <ExternalLink className="h-4 w-4" />
                  Demo
                </a>
              ...
              {submission.repo_url && (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 px-3 py-2 bg-gray-500/20 text-gray-400 rounded text-sm font-space hover:bg-gray-500/30 transition-colors"
                >
                  <Github className="h-4 w-4" />
                  Repository
                </a>
              ...
              {submission.video_url && (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 px-3 py-2 bg-red-500/20 text-red-400 rounded text-sm font-space hover:bg-red-500/30 transition-colors"
                >
                  <Video className="h-4 w-4" />
                  Video
                </a>
          ...
          {/* Scoring Form */}
          <div className="pt-2">
            <h4 className="font-space font-bold text-xs text-gray-400 mb-3">
