...
const MakeathonsFutureEducation = () => {
  const content = (
    <div className="space-y-6">
      ...
      <p>
        <strong>Theoretical Over Practical:</strong> Students can recite complex formulas but struggle to apply knowledge to real-world problems. The gap between classroom learning and practical application leaves graduates unprepared for actual work environments.
      </p>
      ...
      <ul className="list-disc pl-6 space-y-2">
        ...
        <li>Digital literacy and technological fluency</li>
        <li>Creative thinking and innovation capabilities</li>
        <li>Leadership and project management experience</li>
      </ul>

      <p>
        <strong>What Traditional Education Provides:</strong>
      </p>
      <ul className="list-disc pl-6 space-y-2">
        <li>Subject-specific knowledge</li>
        <li>Test-taking abilities</li>
        <li>Individual academic achievement</li>
        <li>Compliance and rule-following</li>
      ...
      <ul className="list-disc pl-6 space-y-2">
        <li>Identifying real-world problems through observation and interview</li>
        <li>Market research and competitive analysis</li>
        <li>User persona development and journey mapping</li>
        <li>Problem validation through data collection</li>
      </ul>

      <p>
        <strong>Skills Developed:</strong> Research methodology, data analysis and interpretation, empathy and user-centric thinking, market analysis capabilities
      </p>

      <p>
        <strong>Day 3-4: Solution Design and Prototyping</strong>
      </p>
      <ul className="list-disc pl-6 space-y-2">
        <li>Brainstorming and ideation techniques</li>
        <li>Solution architecture and design thinking</li>
        <li>Rapid prototyping using modern tools</li>
      ...
      <ul className="list-disc pl-6 space-y-2">
        <li>Broad theoretical understanding across subjects</li>
        <li>Ability to perform well on standardized tests</li>
        <li>Limited real-world application experience</li>
        <li>Individual achievement focus</li>
        <li>Risk-averse mindset</li>
      </ul>

      <p>
        <strong>Makeathon Education Outcomes (After 1 Week + Follow-up):</strong>
      </p>
      <ul className="list-disc pl-6 space-y-2">
        <li>Deep understanding of chosen problem domain</li>
        <li>Practical application of multiple disciplines</li>
        <li>Hands-on building and creation experience</li>
        <li>Team-based achievement and collaboration</li>
...
export default MakeathonsFutureEducation;