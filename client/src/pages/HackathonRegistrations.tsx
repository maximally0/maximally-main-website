...
export default function HackathonRegistrations() {
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-7xl mx-auto animate-pulse space-y-8">
              ...
              <div className="space-y-4">
                <div className="h-4 w-32 bg-gray-900/30 rounded"></div>
                <div className="h-10 w-80 bg-gray-900/30 rounded"></div>
              ...
              <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
                {[1, 2, 3, 4, 5].map(i => (
                  <div key={i} className="bg-gradient-to-br from-gray-900/60 to-gray-900/30 border border-gray-700 p-4">
                    <div className="h-8 w-12 bg-gray-900/30 rounded mb-2"></div>
  ...
  return (
    <div className="min-h-screen bg-black text-white relative">
      ...
      <div className="fixed inset-0 bg-black pointer-events-none" />
      <div className="fixed inset-0 bg-[linear-gradient(rgba(255,255,255,0.02)_1px,transparent_1px),linear-gradient(90deg,rgba(255,255,255,0.02)_1px,transparent_1px)] bg-[size:50px_50px] pointer-events-none" />
      <div className="fixed inset-0 bg-gradient-to-br from-gray-950/20 via-transparent to-gray-950/20 pointer-events-none" />
      <div className="fixed top-1/4 left-1/4 w-[300px] h-[300px] bg-orange-500/10 rounded-full blur-[120px] animate-pulse pointer-events-none" />
      <div className="fixed bottom-1/4 right-1/4 w-[250px] h-[250px] bg-orange-500/5 rounded-full blur-[100px] animate-pulse pointer-events-none" style={{ animationDelay: '1s' }} />
      ...
      <div className="relative z-10 pt-24 pb-16">
        <div className="container mx-auto px-4">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="mb-8">
              <Link 
                ...
                className="text-orange-400 hover:text-orange-400 font-space font-bold text-sm mb-4 inline-flex items-center gap-2 transition-colors"
              >
                ← BACK_TO_DASHBOARD
              </Link>
              <h1 className="font-space font-bold text-3xl bg-gradient-to-r from-orange-400 to-orange-500 bg-clip-text text-transparent mb-2">
                MANAGE_HACKATHON
              </h1>
            ...
            <div className="grid grid-cols-2 md:grid-cols-5 gap-4 mb-8">
              <div className="bg-gradient-to-br from-gray-900/50 to-gray-900/20 border border-gray-800 p-4 hover:border-orange-500/50 transition-all">
                <div className="text-2xl font-bold text-orange-400 mb-1 font-space font-bold">
                  {stats.total}
                </div>
                <div className="text-xs text-gray-500 font-space font-bold">TOTAL</div>
              </div>
              <div className="bg-gradient-to-br from-green-900/40 to-emerald-900/20 border border-green-500/30 p-4 hover:border-green-400/50 transition-all">
                <div className="text-2xl font-bold text-green-300 mb-1 font-space font-bold">
                  {stats.confirmed}
                </div>
              ...
              <div className="bg-gradient-to-br from-gray-900/40 to-blue-900/20 border border-gray-700 p-4 hover:border-gray-600/50 transition-all">
                <div className="text-2xl font-bold text-gray-300 mb-1 font-space font-bold">
                  {stats.checkedIn}
                </div>
              ...
              <div className="bg-gradient-to-br from-amber-900/40 to-orange-900/20 border border-amber-500/30 p-4 hover:border-amber-400/50 transition-all">
                <div className="text-2xl font-bold text-amber-300 mb-1 font-space font-bold">
                  {stats.waitlist}
                </div>
                <div className="text-xs text-gray-500 font-space font-bold">WAITLIST</div>
              </div>
              <div className="bg-gradient-to-br from-gray-900/40 to-rose-900/20 border border-gray-800 p-4 hover:border-orange-500/50 transition-all">
                <div className="text-2xl font-bold text-orange-400 mb-1 font-space font-bold">
                  {stats.teams}
                </div>
                <div className="text-xs text-gray-500 font-space font-bold">TEAMS</div>
              </div>
            </div>
            ...
            <div className="flex gap-2 mb-6 overflow-x-auto pb-2">
              {[
                ...
                <button
                  ...
                  className={`px-6 py-3 font-space font-bold text-xs whitespace-nowrap transition-all ${
                    activeTab === tab.id
            ...
            <div className="space-y-6">
              ...
              <div className="bg-gradient-to-br from-gray-900/60 to-gray-900/30 border border-gray-700 p-6">
                <div className="flex flex-col md:flex-row gap-4">
                  <div className="flex-1">
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full bg-black/50 border border-gray-800 text-white pl-10 pr-4 py-3 font-space focus:border-orange-500 outline-none"
                      />
                    </div>
                  </div>
                  <select
                    ...
                    className="bg-black/50 border border-gray-800 text-white px-4 py-3 font-space focus:border-orange-500 outline-none"
                  >
                  ...
                  <button
                    onClick={exportToCSV}
                    className="bg-gradient-to-r from-orange-600 to-orange-500 border border-orange-500/50 hover:border-orange-500 text-white hover:text-white px-6 py-3 font-space font-bold text-xs transition-all flex items-center gap-2"
                  >
              ...
              {selectedRegistrations.length > 0 && (
                <div className="bg-gradient-to-r from-orange-600/20 to-orange-500/10 border border-orange-500/50 p-4">
                  <div className="flex flex-col md:flex-row items-center justify-between gap-4">
                    ...
                    <div className="flex flex-wrap gap-2">
                      <button
                        ...
                        className="bg-gradient-to-r from-orange-600 to-orange-500 border border-gray-700 hover:border-gray-600 text-gray-300 px-4 py-2 font-space font-bold text-xs flex items-center gap-2 disabled:opacity-50 transition-all"
                      >
                      ...
                      <button
                        ...
                        disabled={bulkActionLoading}
                        className="bg-gradient-to-r from-red-600/40 to-rose-500/30 border border-red-500/50 hover:border-red-400 text-red-200 px-4 py-2 font-space font-bold text-xs flex items-center gap-2 disabled:opacity-50 transition-all"
                      >
                      ...
                      <button
                        ...
                        className="bg-gray-800/50 border border-gray-700 text-gray-300 hover:text-white px-4 py-2 font-space font-bold text-xs hover:border-gray-600 transition-all"
                      >
                        CLEAR
                      </button>
                    </div>
              ...
              <div className="flex items-center gap-3 px-2">
                ...
                <span className="text-gray-500 font-space text-sm">
              ...
              <div className="space-y-4">
                {filteredRegistrations.length === 0 ? (
                  <div className="bg-gradient-to-br from-gray-800/50 to-gray-900/50 border border-gray-700 p-12 text-center">
                    ...
                    <p className="font-space font-bold text-gray-400">NO_REGISTRATIONS_FOUND</p>
                  </div>
                ) : (
                      ...
                      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                        ...
                        <div className="flex-1">
                          <div className="flex items-center gap-3 mb-3">
                            ...
                            <span className={`px-3 py-1 text-xs font-space font-bold ${
                              reg.status === 'confirmed' ? 'bg-green-500/20 text-green-500 border border-green-500' :
                              reg.status === 'checked_in' ? 'bg-gray-800 text-blue-500 border border-blue-500' :
                            ...
                            {reg.team && (
                              <span className="px-3 py-1 text-xs font-space font-bold bg-orange-500/10 text-orange-400 border border-orange-500">
                                TEAM: {reg.team.team_name}
                              </span>
                            )}
                          </div>

                          <div className="grid grid-cols-1 md:grid-cols-2 gap-2 text-sm font-space text-gray-400">
                        ...
                        <div className="flex flex-col gap-2 items-end">
                          <div className="text-xs font-space font-bold text-gray-500">
                            #{reg.registration_number}
                          </div>
                          ...
                          <div className="flex items-center gap-2">
                            {reg.status === 'confirmed' && (
                              <button
                                ...
                                className="bg-gradient-to-r from-orange-600 to-orange-500 border border-gray-700 hover:border-gray-600 text-gray-300 px-4 py-2 font-space font-bold text-xs flex items-center gap-2 transition-all"
                              >
                                <UserCheck className="h-4 w-4" />
                                CHECK_IN
                              </button>
                            ...
                            <div className="relative">
                              ...
                              {showParticipantMenu === reg.id && (
                                <div className="absolute right-0 top-full mt-1 bg-gray-900/95 border border-gray-800 shadow-lg z-50 min-w-[180px] backdrop-blur-sm">
                                  {reg.status !== 'cancelled' && (
                                    <button
                                      onClick={() => handleUnregister(reg.id)}
                                      className="w-full px-4 py-3 text-left text-sm font-space text-amber-400 hover:bg-orange-500/10 flex items-center gap-2 transition-colors"
                                    >
                                      <UserMinus className="h-4 w-4" />
                                      Unregister
                                    </button>
                                  ...
                                  <button
                                    ...
                                    className="w-full px-4 py-3 text-left text-sm font-space text-red-400 hover:bg-gray-800 flex items-center gap-2"
                                  >
          ...
          {activeTab === 'teams' && (
            <div className="space-y-4">
              {teams.length === 0 ? (
                <div className="bg-gradient-to-br from-gray-800/50 to-gray-900/50 border border-gray-700 p-12 text-center">
                  <Users className="h-12 w-12 text-gray-600 mx-auto mb-4" />
                  <p className="font-space font-bold text-gray-400">NO_TEAMS_FORMED_YET</p>
                </div>
              ) : (
                teams.map((team) => (
                  <div
                    key={team.id}
                    className="bg-gradient-to-br from-gray-900/60 to-gray-900/30 border border-gray-700 p-6 hover:border-gray-800 transition-all"
                  >
                    <div className="flex items-center justify-between mb-4">
                      <div>
                        ...
                        <p className="text-sm text-gray-400 font-space">
                          Team Code: <span className="text-orange-400 font-space font-bold">{team.team_code}</span>
                        </p>
                      </div>
                      <div className="text-right">
                        <div className="text-2xl font-bold text-orange-400 font-space font-bold">
                          {team.members[0]?.count || 0}
                        </div>
                        <div className="text-xs text-gray-500 font-space font-bold">MEMBERS</div>
                      </div>
                    </div>
          ...
          {activeTab === 'submissions' && (
            <div className="space-y-4">
              ...
              {submissions.length > 0 && (() => {
                ...
                return (
                  <div className="bg-gradient-to-br from-gray-900/40 to-gray-900/10 border border-gray-800 p-6 mb-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                      {tracks.map(track => (
                        <div key={track} className="bg-black/30 border border-gray-700 p-4 hover:border-orange-500/50 transition-all">
                          <div className="flex items-center justify-between mb-2">
                            <span className="font-space font-bold text-xs text-gray-300 truncate max-w-[150px]" title={track}>
                              {track.toUpperCase()}
                            </span>
                            {trackStats[track].avgScore > 0 && (
                              <div className="flex items-center gap-1">
                                <Star className="h-4 w-4 text-amber-400" />
                                <span className="font-space font-bold text-sm text-amber-300">{trackStats[track].avgScore}</span>
                              </div>
                            )}
                          </div>
                          ...
                          {trackStats[track].count > 0 && (
                            <div className="mt-2 h-1 bg-gray-700 rounded-full overflow-hidden">
                              <div 
                                className="h-full bg-gradient-to-r from-orange-500 to-orange-500 transition-all"
              ...
              {submissions.length === 0 ? (
                <div className="bg-gradient-to-br from-gray-800/50 to-gray-900/50 border border-gray-700 p-12 text-center">
                  ...
                  <p className="font-space font-bold text-gray-400">NO_SUBMISSIONS_YET</p>
                </div>
              ) : (
                submissions.map((submission) => (
                  <div key={submission.id} className="bg-gradient-to-br from-gray-900/60 to-gray-900/30 border border-gray-700 p-6 hover:border-gray-800 transition-all">
                    <div className="flex items-start justify-between gap-4">
                      <div className="flex-1">
                        <div className="flex items-start gap-3 mb-2">
                          ...
                          <div>
                            <h3 className="font-space font-bold text-lg text-white">{submission.project_name}</h3>
                            {submission.tagline && (
                              <p className="text-sm text-gray-400 font-space italic">"{submission.tagline}"</p>
                            )}
                          </div>
                        </div>
                        
                        <p className="text-sm text-gray-300 font-space mb-3 line-clamp-2">{submission.description}</p>
                        ...
                        <div className="flex flex-wrap gap-3 mb-3">
                          {submission.github_repo && (
                            <a href={submission.github_repo} target="_blank" rel="noopener noreferrer"
                               className="text-orange-400 hover:text-orange-400 text-sm font-space flex items-center gap-1 transition-colors">
                          ...
                          {submission.demo_url && (
                            <a href={submission.demo_url} target="_blank" rel="noopener noreferrer"
                               className="text-gray-300 hover:text-gray-300 text-sm font-space flex items-center gap-1 transition-colors">
                        ...
                        <div className="text-xs text-gray-500 font-space">
                          ...
                          {submission.track && (
                            <span className="ml-2 px-2 py-0.5 bg-gray-800 text-gray-300 border border-gray-700 rounded">
                              {submission.track}
                            </span>
                          )}
                        </div>
                      ...
                      <div className="flex-shrink-0 min-w-[200px]">
                          ...
                          {(submission.average_score || submission.score) ? (
                            <>
                              <div className="flex items-center justify-end gap-2">
                                ...
                                <span className="text-2xl font-bold text-amber-300 font-space font-bold">
                                  {submission.average_score || submission.score}
                                </span>
                              </div>
                            ...
                            <span className="text-xs text-gray-500 font-space">Not scored yet</span>
                          )}
                        </div>
                        ...
                        {submission.prize_won && (
                          <div className="text-right mb-3">
                            <span className="px-3 py-1 text-xs font-space font-bold bg-amber-500/20 text-amber-300 border border-amber-500/50">
                              {submission.prize_won}
                            </span>
                          </div>
                        )}
                        ...
                        {(submission.average_score || submission.score) && (
                          <div className="text-right mb-3">
                            <button
                              ...
                              className="bg-gradient-to-r from-orange-600 to-orange-500 border border-orange-500/50 hover:border-orange-500 text-white px-3 py-2 text-xs font-space font-bold flex items-center gap-2 ml-auto transition-all"
                            >
                        ...
                        {submission.judge_scores && submission.judge_scores.length > 0 && (
                          <div className="bg-gray-800/50 border border-gray-700 p-3 rounded">
                            <div className="flex items-center justify-between mb-2">
                              <p className="text-xs text-gray-400 font-space font-bold">JUDGE_SCORES</p>
                              <button
                                onClick={() => setSelectedSubmission(submission)}
                                className="text-xs text-maximally-yellow hover:text-maximally-red font-space flex items-center gap-1"
                              >
                            ...
                            <div className="space-y-2">
                              {submission.judge_scores.slice(0, 3).map((js: any, idx: number) => (
                                <div key={idx} className="flex items-center justify-between text-xs">
                                  <span className="text-gray-400 font-space truncate max-w-[100px]" title={js.judge_name}>
                                    {js.judge_name}
                                  </span>
                                  <span className="text-maximally-yellow font-space font-bold">{js.score}</span>
                                </div>
                              ))}
                              {submission.judge_scores.length > 3 && (
                                <button
                                  onClick={() => setSelectedSubmission(submission)}
                                  className="text-xs text-gray-500 hover:text-orange-400 font-space transition-colors"
                                >
              ...
              {selectedSubmission && (
                <div className="fixed inset-0 bg-black/90 backdrop-blur-sm flex items-center justify-center z-50 p-4">
                  <div className="bg-gradient-to-br from-gray-900 to-gray-950 border border-orange-500/50 max-w-2xl w-full max-h-[90vh] overflow-y-auto">
                    {/* Modal Header */}
                    <div className="sticky top-0 bg-gradient-to-r from-gray-900/50 to-gray-900/30 border-b border-gray-800 p-4 flex items-center justify-between">
                      <div>
                        <h3 className="font-space font-bold text-lg text-white">{selectedSubmission.project_name}</h3>
                        <p className="text-sm text-gray-400 font-space">
                    ...
                    <div className="p-6 space-y-6">
                      ...
                      <div className="text-center p-4 bg-gradient-to-br from-amber-900/30 to-orange-900/20 border border-amber-500/30">
                        <p className="text-xs text-gray-400 font-space font-bold mb-2">AVERAGE_SCORE</p>
                        <div className="flex items-center justify-center gap-2">
                          <Star className="h-8 w-8 text-amber-400" />
                          <span className="text-4xl font-bold text-amber-300 font-space font-bold">
                            {selectedSubmission.average_score || selectedSubmission.score || 'N/A'}
                          </span>
                        </div>
                        <p className="text-xs text-gray-500 font-space mt-2">
                      ...
                      {/* Individual Judge Scores */}
                      <div>
                        <h4 className="font-space font-bold text-sm bg-gradient-to-r from-orange-400 to-orange-500 bg-clip-text text-transparent mb-4">SCORES_BY_JUDGE</h4>
                        {selectedSubmission.judge_scores && selectedSubmission.judge_scores.length > 0 ? (
                          <div className="space-y-4">
                            {selectedSubmission.judge_scores.map((js: any, idx: number) => (
                              <div key={idx} className="bg-gradient-to-br from-gray-800/50 to-gray-900/50 border border-gray-800 p-4">
                                <div className="flex items-center justify-between mb-3">
                                  <div className="flex items-center gap-3">
                                    <div className="w-10 h-10 bg-gradient-to-br from-orange-600 to-orange-500 flex items-center justify-center">
                                      <span className="text-white font-space font-bold text-sm">
                                        {js.judge_name?.charAt(0)?.toUpperCase() || 'J'}
                                      </span>
                                    </div>
                                    <div>
                                      <p className="text-white font-space font-medium">{js.judge_name}</p>
                                      <p className="text-xs text-gray-500 font-space">
                                  ...
                                  <div className="text-right">
                                    <span className="text-2xl font-bold text-amber-300 font-space font-bold">{js.score}</span>
                                    <span className="text-gray-500 font-space">/100</span>
                                  </div>
                                </div>
                                ...
                                {js.criteria_scores && (
                                  <div className="mt-3 pt-3 border-t border-gray-700">
                                    <p className="text-xs text-gray-400 font-space font-bold mb-2">CRITERIA_BREAKDOWN</p>
                                    <div className="grid grid-cols-2 gap-2">
                                      {Object.entries(js.criteria_scores).map(([criterion, score]: [string, any]) => (
                                        <div key={criterion} className="flex items-center justify-between text-xs">
                                          <span className="text-gray-400 font-space capitalize">{criterion}</span>
                                          <span className="text-white font-space">{score}/20</span>
                                        </div>
                                      ))}
                                    </div>
                                  </div>
                                ...
                                {js.notes && (
                                  <div className="mt-3 pt-3 border-t border-gray-700">
                                    <p className="text-xs text-gray-400 font-space font-bold mb-2">NOTES</p>
                                    <p className="text-sm text-gray-300 font-space">{js.notes}</p>
                                  </div>
                                )}
                              </div>
                            ))}
                    ...
                    {/* Modal Footer */}
                    <div className="sticky bottom-0 bg-gradient-to-r from-gray-900 to-gray-950 border-t border-gray-800 p-4">
                      <button
                        onClick={() => setSelectedSubmission(null)}
                        className="w-full bg-gradient-to-r from-orange-600 to-orange-500 border border-orange-500/50 hover:border-orange-500 text-white hover:text-white px-4 py-3 font-space font-bold text-sm transition-all"
                      >
                        CLOSE
                      </button>
                    </div>
          ...
          {activeTab === 'settings' && hackathon && (
            <div className="space-y-6">
              <h2 className="font-space font-bold text-xl bg-gradient-to-r from-orange-400 to-orange-500 bg-clip-text text-transparent mb-2">PERIOD_CONTROLS</h2>
              ...
              <div className="bg-gradient-to-br from-gray-900/60 to-gray-900/30 border border-gray-800 p-6 hover:border-orange-500/50 transition-all">
                <div className="flex items-center justify-between mb-4">
                  <div>
                    <h3 className="font-space font-bold text-lg text-white mb-2">REGISTRATION_PERIOD</h3>
                    ...
                    if (registrationControl === 'closed') {
                      return (
                        <div className="flex items-center gap-2">
                          ...
                          <span className="font-space font-bold text-red-500 text-sm">CLOSED</span>
                        </div>
                      );
                    }
                    if (registrationControl === 'open') {
                      return (
                        <div className="flex items-center gap-2">
                          ...
                          <span className="font-space font-bold text-green-500 text-sm">OPEN</span>
                        </div>
                      );
                    }
                    // Auto mode
                    ...
                    if (regNotOpen) {
                      return (
                        <div className="flex items-center gap-2">
                          ...
                          <span className="font-space font-bold text-yellow-500 text-sm">NOT_OPEN</span>
                        </div>
                      );
                    }
                    return (
                  ...
                  <button
                    ...
                    className={`px-6 py-3 font-space font-bold text-xs transition-all ${
                      registrationControl === 'auto'
                        ? 'bg-gradient-to-r from-blue-600/60 to-gray-700/40 text-white border border-blue-400/50'
                        : 'bg-gray-800/50 text-gray-400 border border-gray-700 hover:border-gray-600'
                    }`}
                  >
                    AUTO
              ...
              <div className="bg-gradient-to-br from-gray-900/60 to-gray-900/30 border border-orange-500/30 p-6 hover:border-orange-400/50 transition-all">
                <div className="flex items-center justify-between mb-4">
                  <div>
                    <h3 className="font-space font-bold text-lg text-white mb-2">BUILDING_PHASE</h3>
                    <p className="text-xs text-gray-400 font-space mb-1">Hacking time - no submissions allowed</p>
                  ...
                  {(() => {
                    ...
                    if (buildingControl === 'closed') {
                      return (
                        <div className="flex items-center gap-2">
                          <div className="w-3 h-3 bg-red-500 rounded-full"></div>
                          <span className="font-space font-bold text-red-500 text-sm">ENDED</span>
                        </div>
                      );
                    }
                    if (buildingControl === 'open') {
                      return (
                        <div className="flex items-center gap-2">
                          ...
                          <span className="font-space font-bold text-orange-500 text-sm">ACTIVE</span>
                        </div>
                      );
                    }
                    // Auto mode
                    if (buildingEnded) {
                      return (
                        <div className="flex items-center gap-2">
                          ...
                          <span className="font-space font-bold text-gray-500 text-sm">ENDED</span>
                        </div>
                      );
                    }
                    if (buildingNotStarted) {
                      return (
                        <div className="flex items-center gap-2">
                          <div className="w-3 h-3 bg-yellow-500 rounded-full"></div>
                          <span className="font-space font-bold text-yellow-500 text-sm">NOT_STARTED</span>
                        </div>
                      );
                    }
                    return (
              ...
              <div className="bg-gradient-to-br from-gray-900/60 to-gray-900/30 border border-green-500/30 p-6 hover:border-green-400/50 transition-all">
                <div className="flex items-center justify-between mb-4">
                  <div>
                    <h3 className="font-space font-bold text-lg text-white mb-2">SUBMISSION_PERIOD</h3>
              ...
              <div className="bg-gradient-to-br from-gray-900/60 to-gray-900/30 border border-gray-700 p-6 hover:border-gray-600/50 transition-all">
                <div className="flex items-center justify-between mb-4">
                  <div>
                    <h3 className="font-space font-bold text-lg text-white mb-2">JUDGING_PERIOD</h3>
