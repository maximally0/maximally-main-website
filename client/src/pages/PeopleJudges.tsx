...
const PeopleJudges = () => {
  ...
  // TEMPORARY MOCK DATA - just for display, not saved anywhere
  const mockJudges: Judge[] = [
    {
      id: 1,
      username: 'sarah_ai',
      fullName: 'Sarah Chen',
      headline: 'AI Research Lead at OpenAI',
      shortBio: 'Built ML systems at scale. Love mentoring new builders in AI and data science.',
      currentRole: 'AI Research Lead',
      company: 'OpenAI',
      location: 'San Francisco, CA',
      profilePhoto: 'https://api.dicebear.com/7.x/avataaars/svg?seed=sarah',
      tier: 'legacy',
      primaryExpertise: ['AI', 'Data Science'],
      secondaryExpertise: ['Product'],
      totalEventsJudged: 47,
      totalTeamsEvaluated: 230,
      totalMentorshipHours: 450,
      yearsOfExperience: 12,
      averageFeedbackRating: 5,
      eventsJudgedVerified: true,
      teamsEvaluatedVerified: true,
      mentorshipHoursVerified: true,
      feedbackRatingVerified: true,
      linkedin: 'https://linkedin.com/in/sarah-chen',
      github: 'https://github.com/sarahchen',
      twitter: null,
      website: null,
      languagesSpoken: ['English', 'Mandarin'],
      publicAchievements: 'Led AI research at top labs',
      mentorshipStatement: 'Passionate about helping builders learn AI/ML',
    ...
    },
    {
      ...
      shortBio: 'Scaling systems to billions of users. Here to help builders ship.',
      currentRole: 'Senior Engineering Manager',
      company: 'Meta',
      location: 'London, UK',
      profilePhoto: 'https://api.dicebear.com/7.x/avataaars/svg?seed=raj',
      tier: 'chief',
      primaryExpertise: ['Backend', 'Systems'],
      secondaryExpertise: ['DevOps', 'Security'],
      totalEventsJudged: 28,
      totalTeamsEvaluated: 156,
      totalMentorshipHours: 320,
      ...
      mentorshipStatement: 'Love helping teams scale their infrastructure',
      availabilityStatus: 'available',
      isPublished: true,
    ...
    },
    {
      ...
      headline: 'Product Design Lead at Figma',
      shortBio: 'Design systems enthusiast. Making tech beautiful and accessible.',
      currentRole: 'Product Design Lead',
      company: 'Figma',
      location: 'New York, NY',
      profilePhoto: 'https://api.dicebear.com/7.x/avataaars/svg?seed=emma',
      tier: 'senior',
      primaryExpertise: ['Design', 'Product'],
      secondaryExpertise: ['Frontend'],
      totalEventsJudged: 19,
      totalTeamsEvaluated: 94,
      totalMentorshipHours: 180,
      yearsOfExperience: 8,
      averageFeedbackRating: 5,
      eventsJudgedVerified: true,
      teamsEvaluatedVerified: true,
      ...
      github: null,
      twitter: 'https://twitter.com/emma_design',
      website: null,
      languagesSpoken: ['English', 'Spanish'],
      publicAchievements: null,
      mentorshipStatement: 'Helping designers create amazing user experiences',
      availabilityStatus: 'available',
      isPublished: true,
    ...
    {
      id: 4,
      username: 'mobile_alex',
      fullName: 'Alex Kim',
      headline: 'Mobile Engineering at Stripe',
      shortBio: 'iOS and Android dev. Passionate about fintech and mobile UX.',
      ...
      totalTeamsEvaluated: 48,
      totalMentorshipHours: 95,
      yearsOfExperience: 6,
      ...
      publicAchievements: null,
      mentorshipStatement: 'Teaching mobile development best practices',
      availabilityStatus: 'available',
      isPublished: true,
    ...
    {
      id: 5,
      username: 'blockchain_maya',
      fullName: 'Maya Johnson',
      headline: 'Web3 Developer at Coinbase',
      shortBio: 'Building the decentralized future. Smart contracts are my jam.',
      currentRole: 'Web3 Developer',
      company: 'Coinbase',
      location: 'Austin, TX',
      profilePhoto: 'https://api.dicebear.com/7.x/avataaars/svg?seed=maya',
      tier: 'verified',
      primaryExpertise: ['Blockchain', 'Backend'],
      ...
      linkedin: 'https://linkedin.com/in/maya-johnson',
      github: 'https://github.com/mayaweb3',
      twitter: null,
      website: null,
      languagesSpoken: ['English'],
      publicAchievements: null,
      mentorshipStatement: 'Helping builders understand blockchain technology',
      availabilityStatus: 'available',
      isPublished: true,
    ...
    {
      id: 6,
      username: 'hardware_tom',
      fullName: 'Thomas Wu',
      headline: 'Hardware Engineer at Tesla',
      shortBio: 'Electrical engineer turned builder. Love teaching hardware hacking.',
      currentRole: 'Hardware Engineer',
      company: 'Tesla',
      location: 'Palo Alto, CA',
      profilePhoto: 'https://api.dicebear.com/7.x/avataaars/svg?seed=thomas',
      tier: 'starter',
      primaryExpertise: ['Hardware', 'IoT'],
      secondaryExpertise: ['Systems'],
      totalEventsJudged: 3,
      totalTeamsEvaluated: 12,
      totalMentorshipHours: 24,
      yearsOfExperience: 4,
      averageFeedbackRating: null,
      eventsJudgedVerified: false,
      teamsEvaluatedVerified: false,
      mentorshipHoursVerified: false,
      feedbackRatingVerified: false,
      ...
      languagesSpoken: ['English', 'Mandarin'],
      publicAchievements: null,
      mentorshipStatement: 'Introducing builders to hardware and IoT',
      availabilityStatus: 'available',
      isPublished: true,
    ...
    {
      id: 7,
      username: 'game_dev_nina',
      fullName: 'Nina Okonkwo',
      headline: 'Game Developer at Unity',
      shortBio: 'Making games that inspire. VR and AR are the future.',
      currentRole: 'Game Developer',
      company: 'Unity',
      location: 'Lagos, Nigeria',
      profilePhoto: 'https://api.dicebear.com/7.x/avataaars/svg?seed=nina',
      tier: 'verified',
      primaryExpertise: ['Game Development', 'Frontend'],
      secondaryExpertise: ['Design'],
      totalEventsJudged: 15,
      totalTeamsEvaluated: 67,
      totalMentorshipHours: 130,
      yearsOfExperience: 7,
      averageFeedbackRating: 5,
      eventsJudgedVerified: true,
      teamsEvaluatedVerified: true,
      mentorshipHoursVerified: true,
      feedbackRatingVerified: true,
      linkedin: 'https://linkedin.com/in/nina-okonkwo',
      github: 'https://github.com/ninagamedev',
      twitter: null,
      website: null,
      languagesSpoken: ['English', 'Yoruba'],
      publicAchievements: null,
      mentorshipStatement: 'Passionate about game development education',
      availabilityStatus: 'available',
      isPublished: true,
    ...
    {
      id: 8,
      username: 'security_carlos',
      fullName: 'Carlos Martinez',
      headline: 'Security Architect at Cloudflare',
      shortBio: 'Cybersecurity specialist. Breaking things to make them stronger.',
      currentRole: 'Security Architect',
      company: 'Cloudflare',
      location: 'Madrid, Spain',
      profilePhoto: 'https://api.dicebear.com/7.x/avataaars/svg?seed=carlos',
      tier: 'senior',
      primaryExpertise: ['Security', 'Backend'],
      secondaryExpertise: ['DevOps'],
      totalEventsJudged: 22,
      totalTeamsEvaluated: 103,
      totalMentorshipHours: 210,
      yearsOfExperience: 9,
      averageFeedbackRating: 5,
      eventsJudgedVerified: true,
      teamsEvaluatedVerified: true,
      ...
      github: null,
      twitter: null,
      website: 'https://carlos-security.com',
      languagesSpoken: ['Spanish', 'English', 'Portuguese'],
      publicAchievements: null,
      mentorshipStatement: 'Teaching security best practices to developers',
      availabilityStatus: 'available',
      isPublished: true,
      ...
      timezone: null,
      calendarLink: null,
      compensationPreference: 'negotiable',
      references: null,
      conflictOfInterest: null,
      agreedToNDA: true,
      address: null,
  ...
  const allJudges = apiJudges.length > 0 ? apiJudges : mockJudges;
