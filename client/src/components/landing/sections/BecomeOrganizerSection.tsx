      ...
      <div className="container mx-auto px-4 sm:px-6 relative z-10">
        <div className="text-center mb-12 sm:mb-16">
          <div className="inline-flex items-center gap-2 mb-6 px-4 py-2 bg-orange-500/10 border border-orange-500/30">
            ...
            <span className="font-space font-bold text-[10px] sm:text-xs text-orange-300 tracking-wider">
              BECOME AN ORGANIZER
            </span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5 sm:gap-6 max-w-5xl mx-auto mb-12">
          {organizerPerks.map((perk, index) => (
            ...
            >
              ...
              <h3 className="font-space font-bold text-xs sm:text-sm text-white mb-3 group-hover:text-orange-400 transition-colors">
                {perk.title}
              </h3>
        ...
        <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center">
          <Link
            ...
            className="group flex items-center justify-center gap-3 px-8 py-4 bg-gradient-to-r from-gray-900 to-gray-800 border border-orange-500/40 hover:border-orange-400 text-orange-300 hover:text-white font-space font-bold text-[10px] sm:text-xs transition-all duration-300"
          ...
          <Link
            to="/organizer/apply"
            className="group flex items-center justify-center gap-3 px-8 py-4 bg-gradient-to-r from-orange-600/30 to-amber-500/20 border border-orange-500/50 hover:border-orange-400 text-orange-200 hover:text-white font-space font-bold text-[10px] sm:text-xs transition-all duration-300"
