  ...
  return (
    <div className="pixel-card h-full flex flex-col">
      <div className={`${event.color} text-white p-4 -m-5 mb-6 pixel-border`}>
        <h3 className="font-space font-bold text-lg">{event.title}</h3>
      </div>
      
      <p className="font-space text-maximally-black/80 mb-4">{event.description}</p>
      ...
      <div className="flex items-center mb-4 text-maximally-black/70">
        ...
        <span className="font-space text-sm">Starts in {event.daysLeft} days</span>
      </div>
      
      <div className="mt-auto">
        <div className="flex items-center mb-4 text-maximally-black">
          <DollarSign className="h-4 w-4 mr-1" />
          <span className="font-space font-bold text-lg">{event.price}</span>
        </div>
