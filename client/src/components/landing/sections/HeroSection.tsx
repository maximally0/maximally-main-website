    ...
    <section className="min-h-screen relative flex items-center pt-20 sm:pt-28 pb-16 overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            <span className="block text-white">Infrastructure for</span>
          ...
          >
            Where builders compete, ship real products, and earn reputation.
          </motion.p>
          ...
          >
            <p className="font-space text-xs text-gray-600 tracking-wide mb-5 uppercase text-center">
            ...
            <div className="relative overflow-hidden">
              ...
              <div className="flex animate-marquee hover:pause-marquee whitespace-nowrap">
                {[...credibilityCompanies, ...credibilityCompanies].map((company, i) => (
                  <span key={i} className="flex items-center mx-4 sm:mx-6">
                    <span className="font-space text-sm sm:text-base text-gray-500 font-semibold tracking-wide hover:text-orange-400 transition-colors duration-300 whitespace-nowrap">
                      {company}
                    </span>
