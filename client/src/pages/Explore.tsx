          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-8 sm:mb-12 md:mb-16">
              <div className="inline-flex items-center gap-3 mb-4 sm:mb-6">
                <div className="flex items-center gap-2 px-3 sm:px-4 py-2 bg-purple-500/10 border border-purple-500/30">
                  <Compass className="w-4 h-4 text-purple-400" />
                  <span className="font-press-start text-[11px] sm:text-xs text-purple-300 tracking-wider">
                    DISCOVER MORE
                  </span>
                </div>
              </div>
              ...
              <p className="font-jetbrains text-sm sm:text-base md:text-lg text-gray-400 max-w-2xl mx-auto leading-relaxed px-2">
            ...
            <section className="mb-10 sm:mb-16">
              <div className="flex items-center gap-2 sm:gap-3 mb-5 sm:mb-8">
                <div className="flex items-center gap-2">
                  ...
                  <h2 className="font-press-start text-xs sm:text-sm md:text-base text-purple-400">
                    AVAILABLE NOW
                  </h2>
                </div>
              ...
              <section className="mb-10 sm:mb-16">
                <div className="flex items-center gap-2 sm:gap-3 mb-5 sm:mb-8">
                  <div className="flex items-center gap-2">
                    ...
                    <h2 className="font-press-start text-xs sm:text-sm md:text-base text-gray-500">
                      COMING SOON
                    </h2>
                  </div>
            ...
            <div className="relative p-5 sm:p-8 md:p-10 bg-gradient-to-br from-purple-900/20 via-black to-pink-900/20 border border-purple-500/30 text-center overflow-hidden">
              ...
              <div className="relative z-10">
                <div className="inline-flex items-center justify-center w-10 h-10 sm:w-12 sm:h-12 mb-3 sm:mb-4 bg-purple-500/20 border border-purple-500/40">
                  <Lightbulb className="w-5 h-5 sm:w-6 sm:h-6 text-purple-400" />
                </div>
                <h3 className="font-press-start text-xs sm:text-sm md:text-base text-white mb-3 sm:mb-4 leading-relaxed">
                  Want to suggest something?
                </h3>
                <p className="font-jetbrains text-xs sm:text-sm text-gray-400 mb-5 sm:mb-6 max-w-lg mx-auto leading-relaxed">
                  We're always looking for new ideas. If you have a suggestion for something 
                  we should build, let us know!
                </p>
                <Link
                  to="/contact"
                  className="group inline-flex items-center gap-2 px-4 sm:px-6 py-2.5 sm:py-3 bg-gradient-to-r from-purple-600/30 to-pink-500/20 border border-purple-500/50 hover:border-purple-400 text-purple-300 hover:text-purple-200 font-press-start text-[11px] sm:text-xs transition-all duration-300"
