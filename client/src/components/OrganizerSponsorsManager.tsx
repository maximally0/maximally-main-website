  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <h3 className="font-space font-bold text-lg text-gray-300">SPONSORS ({sponsors.length})</h3>
        <button
        ...
        >
          ...
          <span className="font-space font-bold text-xs">ADD SPONSOR</span>
        </button>
      </div>
      ...
      <div className="grid md:grid-cols-3 gap-4">
        {sponsors.map((sponsor) => (
          <div key={sponsor.id} className="pixel-card bg-gray-900 border-2 border-gray-700 p-4">
            <div className="minecraft-block bg-orange-400 text-black px-2 py-1 inline-block mb-2">
              <span className="font-space font-bold text-xs">{sponsor.sponsor_tier.toUpperCase()}</span>
            </div>
            <h4 className="font-space text-white mb-2">{sponsor.sponsor_name}</h4>
